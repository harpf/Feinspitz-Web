...
<div class="wp-block-group alignfull has-contrast-color has-wine-fade-gradient-background has-text-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--50)">
	...
	<p class="has-gold-color has-text-color has-small-font-size" style="font-weight:600;letter-spacing:0.3em;text-transform:uppercase"><?php esc_html_e( 'Schritt 2 von 2', 'feinspitz' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<h1 class="wp-block-heading has-heading-font-family has-x-large-font-size" style="margin-top:var(--wp--preset--spacing--20);font-weight:600;line-height:1"><?php esc_html_e( 'Kasse', 'feinspitz' ); ?></h1>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}},"fontSize":"medium"} -->
	<p class="has-medium-font-size" style="margin-top:var(--wp--preset--spacing--20)"><?php esc_html_e( 'Nur noch wenige Schritte bis zu Ihrem Genuss. Ihre Daten werden sicher übertragen.', 'feinspitz' ); ?></p>
	<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
