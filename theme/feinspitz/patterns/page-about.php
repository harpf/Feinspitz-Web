...
/**
 * Title: Über uns
 * Slug: feinspitz/page-about
 * Categories: feinspitz
 * Post Types: page
 * Description: Vollständige „Über uns"-Seite - 20 Jahre Erfahrung, erster Anbieter histamingeprüfter Weine der Schweiz.
 * Keywords: über uns, about, geschichte, story, feinspitz
 * Inserter: true
 *
 * @package Feinspitz
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"backgroundColor":"base","textColor":"contrast","layout":{"type":"constrained","contentSize":"960px"}} -->
<div class="wp-block-group alignfull has-contrast-color has-base-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50)">
	...
	<p class="has-gold-color has-text-color has-small-font-size" style="text-transform:uppercase;letter-spacing:0.28em;font-weight:600"><?php esc_html_e( 'Über uns · seit 2004', 'feinspitz' ); ?></p>
	<!-- /wp:paragraph -->

	<!-- wp:heading {"level":1,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":"1.02"}},"fontSize":"xx-large"} -->
	<h1 class="wp-block-heading has-xx-large-font-size" style="font-style:normal;font-weight:600;line-height:1.02"><?php esc_html_e( '20 Jahre Leidenschaft für ehrlichen Genuss', 'feinspitz' ); ?></h1>
	<!-- /wp:heading -->
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50)">
	<!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|50","left":"var:preset|spacing|70"}}}} -->
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:38%">
			...
			<p class="has-wine-color has-text-color has-small-font-size" style="text-transform:uppercase;letter-spacing:0.22em;font-weight:600"><?php esc_html_e( 'Jahre Erfahrung', 'feinspitz' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:62%">
			...
			<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Aus Überzeugung, nicht aus Trend', 'feinspitz' ); ?></h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph -->
			<p><?php esc_html_e( 'Was vor zwei Jahrzehnten mit der Suche nach verträglichen Weinen begann, ist heute ein kuratiertes Sortiment aus Wein und Gourmet-Spezialitäten. Wir arbeiten direkt mit Winzern, verkosten selbst und nehmen nur auf, was uns überzeugt.', 'feinspitz' ); ?></p>
			<!-- /wp:paragraph -->
...
<!-- wp:cover {"gradient":"wine-fade","isDark":true,"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained","contentSize":"820px"}} -->
<div class="wp-block-cover alignfull" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50)"><span aria-hidden="true" class="wp-block-cover__background has-wine-fade-gradient-background has-background-gradient"></span><div class="wp-block-cover__inner-container">
	...
	<p class="has-text-align-center has-gold-color has-text-color has-small-font-size" style="text-transform:uppercase;letter-spacing:0.28em;font-weight:600"><?php esc_html_e( 'Schweizer Premiere', 'feinspitz' ); ?></p>
	<!-- /wp:paragraph -->

	<!-- wp:heading {"textAlign":"center","level":2,"style":{"typography":{"lineHeight":"1.1"}},"textColor":"contrast","fontSize":"x-large"} -->
	<h2 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-x-large-font-size" style="line-height:1.1"><?php esc_html_e( 'Erster Anbieter histamingeprüfter Weine der Schweiz', 'feinspitz' ); ?></h2>
	<!-- /wp:heading -->
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50)">
	<!-- wp:heading {"level":2,"fontSize":"large"} -->
	<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Wofür wir stehen', 'feinspitz' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns" style="margin-top:var(--wp--preset--spacing--50)">
		<!-- wp:column {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}},"border":{"top":{"color":"var:preset|color|gold","width":"3px"}}}} -->
		<div class="wp-block-column" style="border-top-color:var(--wp--preset--color--gold);border-top-width:3px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
		...
		<div class="wp-block-column" style="border-top-color:var(--wp--preset--color--gold);border-top-width:3px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
			<!-- wp:heading {"level":3,"fontSize":"medium"} -->
			<h3 class="wp-block-heading has-medium-font-size"><?php esc_html_e( 'Handverlesen', 'feinspitz' ); ?></h3>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"fontSize":"small"} -->
			<p class="has-small-font-size"><?php esc_html_e( 'Direkter Kontakt zu Winzern und Produzenten. Wir nehmen nur auf, was wir selbst verkostet und für gut befunden haben.', 'feinspitz' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	...
	<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--60)">
		<!-- wp:button -->
		<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/shop"><?php esc_html_e( 'Sortiment entdecken', 'feinspitz' ); ?></a></div>
		<!-- /wp:button -->

		<!-- wp:button {"className":"is-style-outline"} -->
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/kontakt"><?php esc_html_e( 'Kontakt aufnehmen', 'feinspitz' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
